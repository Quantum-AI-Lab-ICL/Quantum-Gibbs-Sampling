...
This repository contains the code for numerical simulations of quantum Gibbs samplers from the papers authored by Štěpán Šmíd, Richard Meister, Mario Berta, and Roberto Bondesan:
